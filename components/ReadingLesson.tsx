...
const ReadingLesson: React.FC<ReadingLessonProps> = ({ lesson, onComplete, onExit }) => {
  return (
    <div className="flex flex-col h-full animate-fade-in">
      ...
      <div className="flex-grow prose prose-lg dark:prose-invert max-w-none bg-white dark:bg-slate-800/50 rounded-xl p-6 md:p-8 overflow-y-auto mb-24 border border-slate-200 dark:border-slate-800">
